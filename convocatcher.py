...
def summarize_text(text, model_name="gemini-2.5-flash", quiet=False):
...
def main():
    ...
    parser.add_argument("--gemini_model", default="gemini-2.5-flash", help="Gemini model to use for summarization. Default is 'gemini-2.5-flash'.")
